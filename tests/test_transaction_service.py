...
def test_transaction_service():
    ...
    response = client.post("/transactions/", json={"from_account": "Account1", "to_account": "Account2", "amount": 100.0})
    ...
    assert response.status_code == 200
    assert response.json() == {"from_account": "Account1", "to_account": "Account2", "amount": 100.0}
